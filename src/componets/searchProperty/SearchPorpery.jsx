        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <div className="">
            ...
            {/* <Dropdown
              ...
              isVisible={dropdowns.location}
              toggleDropdown={() => toggleDropdown("location")}
            />

            <Dropdown
              title="Property Type "
              options={["Apartment", "House", "Villa", "Duplex"]}
              isVisible={dropdowns.propertyType}
              toggleDropdown={() => toggleDropdown("propertyType")}
            />

            <Dropdown
              title="Pricing Range"
              options={["$100k - $500k", "$500k - $1M", "$1M+", "$2M+"]}
              isVisible={dropdowns.pricingRange}
              toggleDropdown={() => toggleDropdown("pricingRange")}
            />
            <Dropdown
              title="Property Size"
              options={["Small", "Medium", "Large", "Executive"]}
              isVisible={dropdowns.propertySize}
              toggleDropdown={() => toggleDropdown("propertySize")}
            />

            <Dropdown
              title="Build Year"
              options={["2020", "2021", "2023-2024", "After 2025"]}
              isVisible={dropdowns.buildYear}
              toggleDropdown={() => toggleDropdown("buildYear")}
            /> */}
          </div>
        </div>
      </div>
